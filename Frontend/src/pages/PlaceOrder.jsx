...
const PlaceOrder = () => {
  ...
  return (
    <div  className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80ht] border-t'>
      {/* --------------------left side------------------- */}
        ...
        <div className='mt-12'>
          ...
          <div className='flex gap-3 flex-col lg:flex-row'>
            ...
            <div onClick={() => setMethod('chapa')} className='flex items-center gap-3 border p-2 px-3 cursor-pointer'>
              ...
              <img className='h-5 mx-4' src={assets.chapa_logo} alt="stripe logo" />
            </div>
          ...
          <div className='w-full text-end mt-8'>
            <button onClick={() => navigate('/orders')} className='bg-black text-white px-16 py-4 text-sm cursor-pointer'>PLACE ORDER</button>
          </div>
        </div>
      </div>
    </div>
